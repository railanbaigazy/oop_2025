    ...
    public static void main(String[] args) {
        ...
        for (DukeTransaction transaction : transactions) {
            if (polos.containsKey(transaction.getProductID())) {
                ...
                System.out.println("Error: Invalid product ID: " + transaction.getProductID());
            }

            switch (transaction.getTransactionType()) {
                case "Purchase":
                    assert currentShirt != null;
                ...
                case "Sale":
                    ...
                    break;
                default:
                    System.out.println("Error: Invalid transaction type: " + transaction.getTransactionType());
            }
        }
        // Convert to List
        ...
        poloList.sort(sortDescription);
        System.out.println("=== Inventory - Desc ===");
        for (Shirt shirt : poloList) {
            System.out.println(shirt.toString());
        }
        // Print Results - Sort by Count
        poloList.sort(sortCount);
